...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="wrap-body" style="height: 392px;">
        <div class="chunk">
            <form action="" method="post" id="login" data-focus="username" runat="server">
                <div class="panel">
                    <div class="inner">
                        <div class="content">
                            <fieldset class="fields1">
                                <dl>
                                    <dt>
                                        <label for="title">Tiêu đề:</label></dt>
                                    <dd>
                                        <input type="text" id="txtTieuDe" runat="server" tabindex="2" name="title" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
                                </dl>
                                <dl>
                                    <dt>
                                        <label for="desc">Thuộc chủ đề</label></dt>
                                    <dd>
                                        <asp:DropDownList ID="DsChuDe" runat="server"></asp:DropDownList></dd>
                                </dl>
                                <dl>
                                    <dt>
                                        <label for="password">Nội dung bài viết:</label></dt>
                                    <dd>
                                        <textarea name="content" class="inputbox autowidth" runat="server" id="noidung">                      
                                          </textarea>
                                    </dd>
                                </dl>
                                <dl>
