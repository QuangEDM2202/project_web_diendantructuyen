                            ...
                            <div class="content">
                                <fieldset class="fields1">
                                    ...
                                    <dl>
                                     ...
                                     <dl>
                                        <dt><label for="password">Số điện thoại:</label></dt>
                                        <dd><input type="text" tabindex="2" id="mobile" name="mobile" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
                                    </dl>
                                     <dl>
                                        <dt><label for="address">Địa chỉ:</label></dt>
                                        <dd><input type="text" tabindex="2" id="address" name="address" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
                                    </dl>
                                     <dl>
                                        <dt><label for="password">Email:</label></dt>
                                        <dd><input type="email" tabindex="2" id="email" name="email" size="25" class="inputbox autowidth" autocomplete="off" /></dd>
                                    </dl>
                                    <dl>
                                        <dt>&nbsp;</dt>
                                        <dd>
                                            <input type="submit" name="register" tabindex="6" value="Đăng ký" class="button1" />
                                        </dd>
                                    </dl>
                                    </fieldset>
                                </div>
