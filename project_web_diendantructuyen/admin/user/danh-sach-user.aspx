    ...
    <h2>Quản lý user</h2>
       <form id="form1" runat="server" method="post">
           ...
           <%--end thông báo--%>
            <%--grid view--%>
            <div class="grid_view">
                <asp:GridView ID="gv_dsUSer" runat="server" AutoGenerateColumns="false" AllowPaging="True" OnPageIndexChanging="gv_dsUSer_PageIndexChanging">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <%--phân trang--%>
                                    <%--<%#get_stt() %>--%>
                                <%--tam comment--%>
                                <%--<asp:LinkButton ID="lnkView" CommandArgument='<%# Eval("id") %>' runat="server" OnClick="lnk_OnClick" >Xem</asp:LinkButton>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
